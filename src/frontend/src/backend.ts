...
import type { OwnerProfile as _OwnerProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addRule(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getOwnerProfile(): Promise<OwnerProfile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getOwnerProfile();
    ...
    async updatePlayerCount(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePlayerCount(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRule(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRule(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OwnerProfile]): OwnerProfile | null {
